...
const WEATHER_TEXTS = {
  'Klar':     { Überschrift:'Klar',     icon:'sun',             titel:'Perfekter Bienentag!',   text:'Heute fliegen die Bienen den ganzen Tag über und besuchen die Blumen in ihrer Umgebung. Bei warmem, sonnigem Wetter sind sie besonders fleißig und sammeln eifrig Nektar und Pollen. Die Sammlerinnen kehren immer wieder mit vollen Höschen zum Stock zurück. Ein perfekter Tag, um das emsige Treiben am Flugloch zu beobachten.', farbe:'green' },
  'Bewölkt':  { Überschrift:'Bewölkt',  icon:'cloud',           titel:'Ruhiges Wetter',         text:'Die Bienen sind aktiv, aber dennoch etwas zurückgehalten. Bei bedecktem Himmel fliegen sie kürzere Strecken und bleiben lieber in der Nähe des Stocks. Sobald die Sonne durch die Wolken bricht, nimmt das Treiben am Flugloch wieder zu. Insgesamt ein ruhiger, aber durchaus brauchbarer Sammeltag.', farbe:'green' },
  'Nebel':    { Überschrift:'Nebel',    icon:'cloud-fog',       titel:'Neblige Morgenstimmung', text:'Die Bienen fliegen wahrscheinlich nicht aus, da es ihnen zu neblig ist. Bei feuchter, trüber Luft finden sie sich schlecht zurecht und verlieren leicht die Orientierung. Sie warten daher lieber im Stock, bis sich der Nebel lichtet. Sobald die Sonne durchkommt, starten die ersten Sammlerinnen ihre Ausflüge.', farbe:'yellow' },
  'Regen':    { Überschrift:'Regen',    icon:'cloud-rain',      titel:'Regentag',               text:'Die Bienen bleiben bei Regen im Stock und warten auf besseres Wetter. Ihre Flügel würden nass und schwer, deshalb meiden sie den Ausflug. Im Inneren nutzen sie die Zeit, um den gesammelten Nektar zu Honig zu verarbeiten und die Waben zu pflegen. Erst wenn es wieder trocken ist, geht es zurück zu den Blüten.', farbe:'red' },
  'Schnee':   { Überschrift:'Schnee',   icon:'snowflake',       titel:'Winterruhe',             text:'Das Volk sitzt in der Wintertraube. Erst im Frühling werden sie wieder aktiv. Dicht aneinandergedrängt halten die Bienen sich gegenseitig warm und zehren von ihren Honigvorräten. Geschützt in der Mitte der Traube sitzt die Königin. Solange es draußen kalt ist, verlassen sie den Stock nur an wenigen milden Tagen.', farbe:'red' },
  'Gewitter': { Überschrift:'Gewitter', icon:'cloud-lightning', titel:'Gewitterwarnung',        text:'Die Bienen sind reizbar und bleiben im Stock. Der plötzliche Luftdruckabfall und die Spannung in der Luft machen sie nervös und verteidigungsbereit. Heimkehrende Sammlerinnen beeilen sich, noch vor dem Unwetter zurück zu sein. An solchen Tagen lässt man den Stock besser in Ruhe.', farbe:'red' },
};
